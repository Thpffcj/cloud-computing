...
object GraphTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val folderPath = "src/main/resources/人物（含昵称）/"
    val graph1 = creatGraph(sc,
      folderPath + "result1/heromap.txt",
      folderPath + "result1/relationship.txt", 15).cache()

    val graph2 = creatGraph(sc,
      folderPath + "result2/heromap.txt",
      folderPath + "result2/relationship.txt", 15).cache()

    val graph3 = creatGraph(sc,
      folderPath + "result3/heromap.txt",
